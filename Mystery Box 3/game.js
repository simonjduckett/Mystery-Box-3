...
function checkKey(e) {
    ...
    if (e.keyCode == '38') {
        ...
        //create a new bullet
        gunsound.play();
        bullets.push(new bullet(gun.x + 20, canvas.height - 50));
    }
...
function draw() {
    ...
    clear = setInterval(function(){
        ...
        for (var j = 0; j < boxes.length; j++) {
         ...
         count++;
         mod = count % 50;//how often a new box is spawned
...
function GameOverScreen() {
        ...
        canvasContext.fillText("GAME OVER you died from stress of the game ", canvas.width/4, 200);
